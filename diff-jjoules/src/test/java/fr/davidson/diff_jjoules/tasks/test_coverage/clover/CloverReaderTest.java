...
public class CloverReaderTest {
    ...
    void test() {
        ...
        assertTrue(coverage.findByTestIdentifier("fr.davidson.AppTest#testRandom").containsFileCoverage("s/diff-jjoules-toy-java-project/src/main/java/fr/davidson/App.java"));
        ...
        assertEquals(expectedCoveredLines.length,
                coverage.findByTestIdentifier("fr.davidson.AppTest#testRandom")
                        .findFileCoverageByFilename("s/diff-jjoules-toy-java-project/src/main/java/fr/davidson/App.java")
                        .covered_lines.size());
