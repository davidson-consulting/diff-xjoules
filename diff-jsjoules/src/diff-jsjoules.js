...
function compute_coverage (absolute_path_project, coverage_output_json) {
  const coverages = []
  for (const sourceFile in coverage_output_json.coverageMap) {
    ...
    for (const coveredStatement in coverageStatementMap) {
...
function compute_test_coverage (coverage_output_json, coverages) {
  ...
  coverage_output_json.testResults.forEach(test_result => {
