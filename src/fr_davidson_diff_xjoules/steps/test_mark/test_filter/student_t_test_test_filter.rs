...
impl TestFilter for StudentTTestTestFilter {
...
impl StudentTTestTestFilter {
    pub fn new() -> StudentTTestTestFilter {
        StudentTTestTestFilter {}
    }
}
...
mod test {
    ...
    fn test_filter() {
        let configuration = Configuration {
            ...
            test_filter: TestFilterEnum::StudentTTest,
        ...
        let test_selection = configuration.test_filter.filter(&configuration, &data);
